...
def user_signup():
    ...
    if not username_error and not password_error and not password_check_error and not email_error:
       # return redirect('/welcome?username={0}'.format(username))
        ...
        return render_template('login.html', username_error=username_error, username=username, password_error=password_error, password=password, email_error=email_error, email=email, password_check=password_check,password_check_error=password_check_error)
